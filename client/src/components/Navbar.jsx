        ...
        <nav className="bg-gray-500  min-w-max ">
            <div className="flex items-center justify-between h-16 p-4">
                ...
                <img
                    ...
                    src="../../public/Bmenu.svg"
                    onClick={openMenu}
                />
                <div
                    id="menu"
                    className="bg-gray-500 hidden absolute flex flex-col w-40 right-0 top-16 p-4 md:p-0 md:flex md:flex-row md:flex-grow md:items-center md:relative md:top-0"
                >
                    <div className="flex flex-grow md:justify-evenly flex-wrap justify-center">
                        <Link
                            to="/products"
                            className="text-white mx-3 hover:text-indigo-700 transition duration-500"
                        >
                            Productos
                        </Link>
                        <Link
