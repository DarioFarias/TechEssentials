...
const Cart = () => {
    const { cartData, cartLoading, cartError, deleteUserCart } =
                ...
                <div className="flex flex-row  items-center justify-evenly p-4 gap-4">
                    ...
                    {cartData ? (
                        <>
                            <Link
                                to="/user/payment"
                                className="text-white text-center text-xs font-bold w-28 py-3 rounded-2xl bg-indigo-700 hover:bg-indigo-500 transition duration-500 cursor-pointer"
                            >
                                Confirmar
                            </Link>
                        </>
